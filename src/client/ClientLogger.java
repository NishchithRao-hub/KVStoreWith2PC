...
public class ClientLogger {
  ...
  // The log file where all client logs will be written.
  ...
  public static void logRMIClient(String message) { log("RMI Client", message); }
  ...
  public static void logRMIClientError(String message, Exception e) {
    logError("RMI Client", message, e);
  }
